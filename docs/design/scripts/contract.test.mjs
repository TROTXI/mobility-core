...
test('all 48 predecessor-free operations have a requirement, scope decision and existing-endpoint assessment', () => {
  ...
  assert.equal(additions.length, 48);
  assert.equal(operationScope.length, 48);
