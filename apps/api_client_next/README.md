# trotxi_api_client_next (EXPERIMENTAL)
The implemented replacement surface: every reviewed cutover operation and nothing else. The thirteen deferred operations are deliberately absent. Generated from target-contract.mjs by build-transport-contract.mjs; do not edit this JSON. NOT DEPLOYED: no environment serves this contract yet, and the server entry below is a placeholder rather than a working host.
...
dependencies:
  trotxi_api_client_next:
    path: /path/to/trotxi_api_client_next
```
