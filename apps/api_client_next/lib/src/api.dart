...
import 'package:trotxi_api_client_next/src/serializers.dart';
import 'package:trotxi_api_client_next/src/auth/api_key_auth.dart';
import 'package:trotxi_api_client_next/src/auth/basic_auth.dart';
import 'package:trotxi_api_client_next/src/auth/bearer_auth.dart';
import 'package:trotxi_api_client_next/src/auth/oauth.dart';
import 'package:trotxi_api_client_next/src/api/driver_assigned_or_own_api.dart';
import 'package:trotxi_api_client_next/src/api/driver_own_api.dart';
import 'package:trotxi_api_client_next/src/api/live_eligible_api.dart';
import 'package:trotxi_api_client_next/src/api/ops_api.dart';
import 'package:trotxi_api_client_next/src/api/ops_or_scoped_worker_api.dart';
import 'package:trotxi_api_client_next/src/api/provider_signature_api.dart';
import 'package:trotxi_api_client_next/src/api/public_api.dart';
import 'package:trotxi_api_client_next/src/api/rider_own_api.dart';
import 'package:trotxi_api_client_next/src/api/self_api.dart';
import 'package:trotxi_api_client_next/src/api/signed_in_catalog_api.dart';

class TrotxiApiClientNext {
