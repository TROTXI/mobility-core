...
import 'package:trotxi_api_client_next/src/model/trip_summary.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'trip_summary_response.g.dart';
...
class _$TripSummaryResponseSerializer implements PrimitiveSerializer<TripSummaryResponse> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.data,
      specifiedType: const FullType(TripSummary),
    );
  }
  ...
  void _deserializeProperties(
    ...
    required TripSummaryResponseBuilder result,
  ...
  @override
  TripSummaryResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = TripSummaryResponseBuilder();
