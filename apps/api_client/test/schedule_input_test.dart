...
// tests for ScheduleInput
void main() {
  final instance = ScheduleInputBuilder();
  // TODO add properties to the builder and call build()

  group(ScheduleInput, () {
    // ScheduleInputDeparture departure
    test('to test the property `departure`', () async {
      // TODO
    });
    ...
    test('to test the property `serviceWindow`', () async {
      // TODO
    });
    ...
    // BuiltList<int> weekdays
    test('to test the property `weekdays`', () async {
      // TODO
    });
