...
// tests for AdminIncidentsGet200ResponseIncidentsInner
void main() {
  final instance = AdminIncidentsGet200ResponseIncidentsInnerBuilder();
  // TODO add properties to the builder and call build()

  group(AdminIncidentsGet200ResponseIncidentsInner, () {
    // String id
