...
class WorkApi {
  ...
  Future<Response<MeWorkRequestsGet200Response>> meWorkRequestsGet({
    ...
    final _path = r'/me/work/requests';
    ...
    MeWorkRequestsGet200Response? _responseData;
    ...
    return Response<MeWorkRequestsGet200Response>(
      data: _responseData,
  ...
  Future<Response<MeWorkRequestsGet200ResponseRequestsInner>>
    ...
    MeWorkRequestsGet200ResponseRequestsInner? _responseData;
    ...
    return Response<MeWorkRequestsGet200ResponseRequestsInner>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<MeWorkRoutesGet200Response>> meWorkRoutesGet({
    ...
    MeWorkRoutesGet200Response? _responseData;
    ...
    return Response<MeWorkRoutesGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
