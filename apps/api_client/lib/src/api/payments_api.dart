...
class PaymentsApi {
  ...
  /// Returns a [Future] containing a [Response] with a [PaymentsSubscribePost200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaymentsSubscribePost200Response>> paymentsTopupPost({ 
    required PaymentsTopupPostRequest paymentsTopupPostRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(PaymentsTopupPostRequest);
      _bodyData = _serializers.serialize(paymentsTopupPostRequest, specifiedType: _type);
