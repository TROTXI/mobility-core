...
class PaymentsApi {
  ...
  Future<Response<PaymentsSubscribePost200Response>> paymentsSubscribePost({ 
    ...
    final _path = r'/payments/subscribe';
    ...
    PaymentsSubscribePost200Response? _responseData;
    ...
    return Response<PaymentsSubscribePost200Response>(
      data: _responseData,
  ...
  Future<Response<WebhooksPaystackPost200Response>> webhooksPaystackPost({ 
    ...
    WebhooksPaystackPost200Response? _responseData;
    ...
    return Response<WebhooksPaystackPost200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
