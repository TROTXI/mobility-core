...
part 'personal_pause_response.g.dart';
...
class _$PersonalPauseResponseSerializer implements PrimitiveSerializer<PersonalPauseResponse> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.data,
      specifiedType: const FullType(PersonalPause),
    );
  }
  ...
  void _deserializeProperties(
    ...
    required PersonalPauseResponseBuilder result,
  ...
  @override
  PersonalPauseResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PersonalPauseResponseBuilder();
